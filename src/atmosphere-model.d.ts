...
export const MULTIPLE_SCATTERING_LUT_SIZE: number;
export const MULTIPLE_SCATTERING_DIRECTIONS: number;
export const MULTIPLE_SCATTERING_STEPS: number;
export const GROUND_ALBEDO: number;
export const SKY_IRRADIANCE_LUT_SIZE: number;
export const SKY_IRRADIANCE_DIRECTIONS: number;
export const SKY_RADIANCE_STEPS: number;
...
export function distanceToGround(r: number, mu: number): number;
export function altitudeSunUv(r: number, muSun: number, size: number): [number, number];
export function altitudeSunRMu(u: number, v: number, size: number): { r: number; muSun: number };
export function multipleScatteringUv(r: number, muSun: number): [number, number];
export function skyIrradianceUv(r: number, muSun: number): [number, number];
export function multipleScatteringRMu(u: number, v: number): { r: number; muSun: number };
