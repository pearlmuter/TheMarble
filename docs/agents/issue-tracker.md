...
Issues and PRDs for this repo live as GitHub issues in `pearlmuter/TheMarble`. Use the `gh` CLI for all operations.
...
- **Frontier query**: select the first unassigned child without an open blocker.
